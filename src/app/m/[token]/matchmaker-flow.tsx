    ...
    <div className="mx-auto max-w-md px-6 py-10">
      ...
      <Card className="mt-6 text-center">
        <p className="mb-2 text-lg font-semibold text-text-primary">
          Want to manage all your matchmaking?
        </p>
        <p className="mb-5 text-sm text-text-secondary leading-relaxed">
          Download the app to track your intros, earn badges, and help more friends find love.
        </p>
        <a
          href="https://apps.apple.com"
          className="inline-flex items-center gap-2.5 rounded-2xl bg-gradient-to-r from-primary to-primary-light px-6 py-3 text-base font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-primary/30"
        >
