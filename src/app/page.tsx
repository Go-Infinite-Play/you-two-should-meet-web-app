      ...
      <section className="relative overflow-hidden px-6 pb-16 pt-16 sm:pb-24 sm:pt-24">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-xl text-lg leading-relaxed text-text-secondary">
            Stop swiping. Let the people who actually know you play matchmaker.
            They&apos;ve been dying to set you up anyway.
          </p>

          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <div className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-primary to-primary-light px-8 py-4 text-lg font-semibold text-white shadow-lg shadow-primary/25">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-text-secondary">
              Three steps. Zero swiping. All heart.
            </p>
          </div>
          ...
          <div className="grid gap-12 sm:grid-cols-3 sm:gap-8">
            <Step
              ...
              description="Download the app and invite the friends who know your type better than you do."
            />
            <Step
              number={2}
              icon="🤝"
              title="Your friends find someone"
              description="They think of someone perfect, write a personal pitch about why you'd click, and send it along."
            />
            <Step
              number={3}
              icon="✨"
              title="Both say yes, you connect"
              description="If you're both interested, you get each other's number. Real connections from people who actually know you."
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-3xl bg-gradient-to-br from-primary/5 to-accent/5 px-8 py-12 text-center sm:px-16 sm:py-16">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-text-secondary">
              Dating apps want you scrolling forever. We want you to meet someone
              and delete the app. Every introduction comes from someone who knows
              you both — that&apos;s a better filter than any algorithm.
            </p>
      ...
      <section className="px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-2xl text-center">
          <p className="mb-4 text-lg text-text-secondary">
            Ready to let your friends do what they&apos;ve been wanting to do?
          </p>
          <div className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-primary to-primary-light px-8 py-4 text-lg font-semibold text-white shadow-lg shadow-primary/25">
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
